...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-[#0B0F14] text-[#E6EDF3]">
      {/* NAVBAR */}
      <nav
        className={`fixed top-0 w-full z-50 bg-[#0B0F14]/90 backdrop-blur border-b border-[#1F2933] transition ${showNav ? "translate-y-0" : "-translate-y-20"}`}
      >
        <div className="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center">
          {/* LOGO */}
          <h1
            className="text-xl font-bold text-[#2F81F7]"
            aria-label="Raj Gadhavi Portfolio"
          >
            Raj Gadhavi
          </h1>
    ...
    ${menuOpen ? "max-h-96 opacity-100 py-4" : "max-h-0 opacity-0 py-0"} bg-[#121821] px-6`}
        ...
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-10 items-center">
          ...
          <div>
            ...
            <p className="text-[#9BA7B4] mb-6">
              Aspiring SOC Analyst with hands-on experience in log analysis,
              threat detection, and incident response. Skilled in identifying
              brute-force attacks, phishing attempts, and suspicious behavior
              using real-world security tools.
            </p>

            <div className="flex flex-wrap gap-4 mb-6">
              <a
                href="#projects"
                className="bg-[#2F81F7] px-6 py-3 rounded-lg hover:bg-[#1f6feb] hover:scale-105 hover:shadow-lg transition duration-300"
              >
                Projects
              </a>
              ...
              <a
                href="#contact"
                className="border border-[#30363D] px-6 py-3 rounded-lg hover:bg-[#121821] hover:scale-105 transition duration-300"
              >
                Contact
              </a>
            </div>
        ...
        <div className="grid md:grid-cols-2 gap-10 items-center">
          ...
          >
            ...
            <p>
              ...
              brute-force attacks, phishing attempts, and unauthorized access by
              analyzing logs and correlating events across systems.
            </p>
            ...
            <p>
              ...
              and <span className="text-white">Linux systems</span>, along with
              tools like Wireshark and Nmap for network analysis.
            </p>

            <p>
              I am highly interested in working in
              <span className="text-[#2F81F7] font-medium">
                {" "}
            ...
            {[
              {
                ...
                desc: "Threat Detection, Log Analysis, Incident Response, SOC Operations",
              },
              {
                title: "⚙️ Tools & Technologies",
                desc: "Splunk, Chronicle, Wireshark, Nmap, Linux, Python, SQL",
              },
              {
                title: "🚀 Career Goal",
                desc: "To become a skilled SOC Analyst and help organizations detect and prevent cyber threats effectively.",
              },
            ].map((card, i) => (
              <div
                key={i}
      ...
      <section id="experience" className="max-w-6xl mx-auto py-24 px-6">
        ...
        <p className="text-center text-[#9BA7B4] mb-16 max-w-2xl mx-auto">
          My journey from web development to cybersecurity through hands-on
          experience, internships, and real-world simulations.
        </p>
        ...
        <div className="relative max-w-3xl mx-auto border-l border-[#1F2933]">
          ...
          <div className="mb-12 pl-10 relative hover:translate-x-2 transition duration-300">
            ...
            <ul className="text-sm text-[#9BA7B4] space-y-2 list-disc ml-4">
              <li>
                <span className="text-white">Deloitte:</span> Incident response
                & threat analysis
              </li>
              <li>
                <span className="text-white">Mastercard:</span> Fraud detection
                & risk analysis
              </li>
              <li>
                <span className="text-white">Commonwealth Bank:</span> SOC
      ...
      <section id="why-hire-me" className="max-w-6xl mx-auto py-24 px-6">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          {[
            ...
            <div
              key={i}
              className="p-5 bg-[#121821] border border-[#1F2933] rounded-xl"
            >
              ✔ {item}
            </div>
          ))}
      ...
      <section id="certifications" className="max-w-6xl mx-auto py-24 px-6">
        ...
        <p className="text-center text-[#9BA7B4] mb-12 max-w-2xl mx-auto">
          Certifications that showcase my knowledge in cybersecurity, systems,
        ...
        <div className="space-y-10">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <div className="p-6 bg-[#121821] border border-[#1F2933] rounded-xl hover:border-[#2F81F7] transition md:col-span-2">
                ...
                <p className="text-sm text-[#9BA7B4]">
                  Deloitte, Mastercard, Commonwealth Bank (Forage) • 4 April
                  2026
                </p>
                <p className="text-sm text-[#9BA7B4] mt-2">
                  Hands-on simulations in SOC workflows, threat detection,
          ...
          <div>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <div className="p-6 bg-[#121821] border border-[#1F2933] rounded-xl hover:border-[#2F81F7] transition md:col-span-2">
                ...
                <p className="text-sm text-[#9BA7B4] mt-2">
                  Covered SIEM tools, threat detection, incident response, and
          ...
          <div>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              {/* CHE */}
              <div className="p-6 bg-[#121821] border border-[#1F2933] rounded-xl hover:border-[#2F81F7] transition md:col-span-2">
                <h3 className="font-semibold text-white">CHE Essentials</h3>
                <p className="text-sm text-[#9BA7B4] mt-2">
                  Gained foundational knowledge in cybersecurity practices and
                  ethical handling of systems.
                </p>
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <div className="p-6 bg-[#121821] border border-[#1F2933] rounded-xl hover:border-[#2F81F7] transition">
                ...
                <p className="text-sm text-[#9BA7B4] mt-2">
                  Learned process management, memory management, scheduling, and
                  OS concepts.
                </p>
              </div>
              ...
              <div className="p-6 bg-[#121821] border border-[#1F2933] rounded-xl hover:border-[#2F81F7] transition">
                ...
                <p className="text-sm text-[#9BA7B4]">NPTEL</p>
                <p className="text-sm text-[#9BA7B4] mt-2">
                  Covered SQL, normalization, indexing, transactions, and
                  database design.
                </p>
              </div>
            </div>
      ...
      <section id="resume" className="max-w-6xl mx-auto py-24 px-6 text-center">
        ...
        <p className="text-[#9BA7B4] mb-12 max-w-xl mx-auto">
          Explore my professional journey including education, cybersecurity
          projects, technical skills, and hands-on experience in SOC operations.
        </p>
        ...
        <div className="grid md:grid-cols-2 gap-10 items-center">
          ...
          <div className="relative p-8 rounded-3xl bg-gradient-to-br from-[#121821] to-[#0B0F14] border border-[#1F2933] shadow-2xl">
            ...
            <p className="text-[#9BA7B4] mb-6 text-sm">
              Get the complete overview of my skills, certifications, projects,
              and experience in one document.
            </p>
      ...
      <section id="contact" className="max-w-5xl mx-auto py-24 px-6">
        ...
        <p className="text-center text-[#9BA7B4] mb-12 max-w-xl mx-auto">
          Have a question, opportunity, or just want to connect? Fill out the
