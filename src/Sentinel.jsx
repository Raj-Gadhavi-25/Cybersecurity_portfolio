...
const Sentinel = () => {
  ...
  return (
    <div className="fixed inset-0 pointer-events-none z-[100]">
      ...
      >
        {/* Fixed-size Container for the Orb */}
        <div className="relative w-16 h-16 md:w-20 md:h-20 flex items-center justify-center">
          
          {/* Chat Bubble - Absolute to the container */}
          <AnimatePresence>
            {isVisible && !isMinimized && (
              <Motion.div
                ...
                className="absolute bottom-full mb-6 w-56 md:w-72 glass-card p-4 rounded-2xl border-[#2F81F7]/40 shadow-[0_0_30px_rgba(47,129,247,0.3)] z-10 left-1/2 -translate-x-1/2"
              >
                ...
                <div className="absolute -bottom-2 left-1/2 -translate-x-1/2 w-4 h-4 glass-card border-t-0 border-l-0 rotate-45 border-[#2F81F7]/30 border-r border-b bg-[#121821]"></div>
              </Motion.div>
            )}
          </AnimatePresence>
          ...
          {/* Drag Hint - Absolute to the container */}
          {!isMinimized && (
            <div className="absolute top-full mt-4 w-max left-1/2 -translate-x-1/2">
              <p className="text-[8px] font-mono text-[#2F81F7]/60 uppercase tracking-[0.2em] font-bold">
